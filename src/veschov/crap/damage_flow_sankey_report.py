"""Streamlit UI for damage flow Sankey diagram."""
...
#         "Damage Flow by Battle",
#         "Upload a battle log to visualize damage flow (iso/base × crit/non-crit).",
...
#     }
#     st.caption(f"Diagnostics: {debug_row_counts}")
#
#     if mismatch_ratio > 0.01:
